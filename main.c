...
int main(void)
{
  ...
  osThreadDef(Task02, Task02_init, osPriorityRealtime, 0, 64);
  Task02Handle = osThreadCreate(osThread(Task02), NULL);

  /* definition and creation of Task03 */
  osThreadDef(Task03, Task03_init, osPriorityHigh, 0, 64);
  Task03Handle = osThreadCreate(osThread(Task03), NULL);

  /* definition and creation of Task04 */
  osThreadDef(Task04, Task04_init, osPriorityHigh, 0, 64);
  Task04Handle = osThreadCreate(osThread(Task04), NULL);

  /* definition and creation of Task01 */
  osThreadDef(Task01, Task01_init, osPriorityHigh, 0, 64);
